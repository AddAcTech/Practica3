...
const Edit = () => {
  ...
  const updateName = async () => {
    try {
      const response = await fetch("http://192.168.1.81:3000/username", {
        method: "PUT",
        headers: {
  ...
  const updateEmail = async () => {
    try {
      const response = await fetch("http://192.168.1.81:3000/email", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const updatePassword = async () => {
    try {
      ...
      const response = await fetch("http://192.168.1.81:3000/password", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
